                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        ...
                                        <?php
                                        $query=mysqli_query($con,"SELECT * FROM tbl_catagory where active=1");
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php 
                                            $query=mysqli_query($con,"SELECT * FROM tbl_subcategory where active=1");
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php $query=mysqli_query($con,"SELECT * from tbl_post where active=1");
                            ...
                            <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        ...
                                        <?php $query=mysqli_query($con,"SELECT * FROM tbl_post where active=0");
                                        $countposts=mysqli_num_rows($query);
                                        ?>
                                        <h2><?php echo htmlentities($countposts);?> <small></small></h2>
