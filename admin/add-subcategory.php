...
if(strlen($_SESSION['login'])==0)
{
    ...
    if(isset($_POST['submitsubcat']))
    {
        ...
        $status=1;
        $sql="INSERT INTO tbl_subcategory(catid,subcatname,subcatdescription,active)VALUES('$catid','$subcatname','$subcatdescription','$status')";
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal" name="category" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control" name="catid" required>
                                                                ...
                                                                <?php
                                                                $sql="SELECT * FROM tbl_catagory WHERE active='1'";
                                                                $query=mysqli_query($con,$sql);
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" value="" name="subcatname" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" rows="5" name="subcatdescription" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
