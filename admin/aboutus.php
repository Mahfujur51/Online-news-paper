...
if(strlen($_SESSION['login'])==0)
{
    ...
    if(isset($_POST['update']))
    {
        ...
        $pagedetails=mysqli_real_escape_string($con,$_POST['pagedetails']);
        $query=mysqli_query($con,"UPDATE tbl_pages SET pagetitle='$pagetitle',pagedetails='$pagedetails' where pagename='$pagename' ");
        if($query)
        {
...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
            $pagetype='aboutus';
            $sql="SELECT * FROM tbl_pages WHERE pagename='$pagetype'";
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box">
                                                ...
                                                <textarea class="summernote" name="pagedetails"  required><?php echo htmlentities($row['pagedetails'])?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
